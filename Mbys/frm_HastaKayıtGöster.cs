...
namespace Mbys
{
    public partial class frm_HastaKayıtGöster : Form
    {
        public frm_HastaKayıtGöster()
        {
            InitializeComponent();
        }
...
private void frm_HastaKayıtGöster_Load(object sender, EventArgs e)
        {


         verileri_goster("select * from hastabilgi   ");
        }
    }
}
